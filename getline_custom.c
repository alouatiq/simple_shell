 ...
 *
 * This function reads a line of input from the specified stream and stores it
 * in the buffer. It returns the number of characters read, or -1 on failure or EOF.
 *
